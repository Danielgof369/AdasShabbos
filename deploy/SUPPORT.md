...
bottom of `/admin`, or email **support@kabbalasshabbos.com** directly.

## The pipeline

```
shul admin  ──/admin form or email──▶  support@kabbalasshabbos.com
                                             │ (GoDaddy forwarding)
                                             ▼
                                   danielsgofman@gmail.com
                                             ...
                                             ▼
        ┌──────────────────────────────────────────────────────────────┐
        │ 1. search: to:support@kabbalasshabbos.com -label:KSI-Handled  │
...
1. **Mailbox**: GoDaddy → Email & Office → Email Forwarding → create
   `support@kabbalasshabbos.com` → forward to `danielsgofman@gmail.com`.
...
- Reply drafts: warm, short, in the requester's language; say what was done
  or when it will land; sign as The Kabolas Shabbos Initiative.
